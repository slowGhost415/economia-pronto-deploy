export const dadosEconomicos = {
    ...
    produtos: {
        arroz:    { nome:"Arroz (kg)",      categoria:"Alimentos",    dados:[24.50,25.00,25.50,26.00,27.00,27.50,28.00,28.50,28.00,27.00,26.50,26.00], cor:"#40C48D" },
        feijao:   { nome:"Feijão (kg)",     categoria:"Alimentos",    dados:[9.50,9.80,10.00,10.50,11.00,11.50,12.00,12.50,12.00,11.50,11.00,10.50],  cor:"#D95F5F" },
        cafe:     { nome:"Café (kg)",       categoria:"Alimentos",    dados:[18.00,18.30,18.70,19.00,19.50,19.80,20.20,20.50,20.30,20.00,19.70,19.40],cor:"#B9855B" },
        acucar:   { nome:"Açúcar (kg)",     categoria:"Alimentos",    dados:[4.20,4.30,4.40,4.55,4.70,4.80,4.90,5.00,4.90,4.80,4.70,4.60],           cor:"#D7A443" },
        leite:    { nome:"Leite (L)",       categoria:"Alimentos",    dados:[5.80,6.00,6.20,6.50,6.80,7.00,7.20,7.50,7.00,6.80,6.50,6.20],           cor:"#E8E2D3" },
        carne:    { nome:"Carne (kg)",      categoria:"Alimentos",    dados:[32.00,33.00,34.00,35.00,36.00,37.00,37.50,38.00,37.50,37.00,36.50,36.00],cor:"#C75555" },
        oleo:     { nome:"Óleo (L)",        categoria:"Alimentos",    dados:[8.50,8.70,9.00,9.50,10.00,10.50,11.00,11.50,11.00,10.50,10.00,9.50],    cor:"#CFAE48" },
        gasolina: { nome:"Gasolina (L)",    categoria:"Combustíveis", dados:[5.50,5.60,5.70,5.80,5.90,6.00,6.10,6.20,6.00,5.90,5.80,5.70],          cor:"#8F9A8B" },
        etanol:   { nome:"Etanol (L)",      categoria:"Combustíveis", dados:[4.40,4.50,4.60,4.70,4.80,4.90,5.00,5.10,5.00,4.90,4.80,4.70],          cor:"#6FCF97" },
        energia:  { nome:"Energia (kWh)",   categoria:"Serviços",     dados:[0.90,0.92,0.95,0.97,1.00,1.02,1.05,1.07,1.05,1.03,1.00,0.98],          cor:"#A0B86E" },
        internet: { nome:"Internet (Mbps)", categoria:"Serviços",     dados:[120,122,125,127,130,132,135,138,136,134,132,130],                        cor:"#57B894" }
    },
